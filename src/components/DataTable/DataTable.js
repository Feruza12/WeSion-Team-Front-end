...
function createData(img, violation_type, comment, author, detected_img, detected_num, location, time) {
    return {
        img, violation_type, comment, author, detected_img, detected_num, location, time
    };
}
...
const headCells = [
    { id: 'img', numeric: false, disablePadding: true, label: 'Car Image' },
    { id: 'violation_type', numeric: true, disablePadding: false, label: 'Violation type' },
    { id: 'comment', numeric: true, disablePadding: false, label: 'Comment' },//fat
    { id: 'author', numeric: true, disablePadding: false, label: 'Author' },
    { id: 'detected_img', numeric: true, disablePadding: false, label: 'Car detected Image' },
    { id: 'detected_num', numeric: true, disablePadding: false, label: 'Car detected Number' },
            ...
            <TableRow>
                ...
                {headCells.map((headCell) => (
                    <StyledTableCell
                        ...
                        padding={headCell.disablePadding ? '5px' : 'default'}
